...
$columns_header = array("post_id", "post_title", "post_date", "post_excerpt", 
	"lat_lng", "location_id", "location_name", "location_notes", "street_address", 
...
foreach( $results as $result ) {
  ...
  $custom_fields = get_post_custom($result->ID);
	...
	fputcsv($export_file, array($result->ID, $title, $post_date, $post_excerpt, $latlng, $location_id, $location_name, 
